...
```jsonc
{ "channels": { "log": true, "webhook": true, "email": false, "sms": false, "siren": true, "push": false } }
```
...
```jsonc
{
  ...
  "quietHours": { "start": "22:00", "end": "07:00", "tz": "Europe/Dublin", "overrideSeverity": "critical" },
  "escalation": [
  ...
  "webhookUrl": "https://…", "smsNumber": "+1…", "email": "me@…"
}
```
